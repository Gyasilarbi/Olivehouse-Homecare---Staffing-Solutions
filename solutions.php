  ...
  <body>
        ...
        >
          ...
          <nav id="navmenu" class="navmenu">
            <ul>
              ...
              <!-- <li><a href="#meetourstaff">Meet Our Staff</a></li> -->
              <li><a href="solutions.php" class="active">Staffing Solutions</a></li>
    ...
    <footer id="footer" class="footer light-background">
      <div class="container footer-top">
        <div class="row gy-4">
          <div
            class="col-lg-6 col-md-6 footer-about d-flex justify-content-center"
          >
            <a href="index.html" class="logo d-flex">
              <img
                ...
                alt=""
                style="
                  transform: scale(4); /* Scale the image to double its size */
                  transform-origin: 0 0;
                "
              />
            </a>
          ...
          <div
            class="col-lg-6 col-md-6 footer-links d-flex flex-column justify-content-center align-items-center text-center"
          >
